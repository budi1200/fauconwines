...
class Content extends Component{
    ...
    render(){
        ...
        return(
            <div>
                ...
                <div className="left-wrapper">
                    ...
                    <div className="body-percent textstyle-body-leftmenu"><span>100%</span> <div className="leftmenu-line"></div> <span> {this.props.content.contains} <br/> Méthode Classique</span></div>
      ...
      transitionLeaveTimeout={1000}>*/}
                        <span key={this.props.content.title} className="img-title textstyle-body-img-title">{this.props.content.title}</span>
                    {/*</CSSTransitionGroup>*/}
                    <div className="scroll-nav">
                        ...
                        <div className="scroll-nav-line"></div>
                    </div>
